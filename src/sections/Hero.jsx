...
const ROLES = ['Full-Stack Developer', 'MERN Stack Engineer', 'React Developer', 'Freelancer'];
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center pt-24 pb-16">
        ...
        >
          ...
          <span className={`text-sm font-medium ${isDark ? 'text-[#9CA3AF]' : 'text-gray-600'}`}>
        ...
        >
          Building high-performance, scalable Web & Mobile Apps. I help startups and businesses turn their ideas into beautiful, functional products.
        </motion.p>
        ...
        >
          <Button onClick={() => handleScroll('contact')} variant="glow" size="lg">
            Start a Project <ArrowRight size={16} />
          </Button>
          <Button onClick={() => handleScroll('projects')} variant="outline" size="lg">
            View My Work
          </Button>
        </motion.div>
        ...
        >
          {[
            ...
            { icon: LinkedinIcon, href: 'https://linkedin.com/in/delli-babu-s', label: 'LinkedIn' },
          ...
          <div className={`w-px h-6 ${isDark ? 'bg-[#1F2A25]' : 'bg-green-200'}`} />
          <a
            href="/resume.pdf"
            className={`
        ...
        >
          ...
          >
            <span className={`text-xs ${isDark ? 'text-[#9CA3AF]/50' : 'text-gray-400'}`}>scroll</span>
            <div className={`w-px h-8 ${isDark ? 'bg-linear-to-b from-[#9CA3AF]/30 to-transparent' : 'bg-linear-to-b from-gray-400/30 to-transparent'}`} />
          </motion.div>
        </motion.div>
      </div>
    </section>
